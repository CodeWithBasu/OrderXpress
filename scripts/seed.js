...
const products = [
  ...
  { id: 501, name: "Classic Beef Burger", price: 349, cost: 140, category: "food", description: "Juicy beef patty with fresh lettuce and cheese.", stock: 70, lowStockThreshold: 15, image: "/classic-beef-burger.png" },
  { id: 502, name: "Veggie Pizza", price: 499, cost: 190, category: "food", description: "Loaded with fresh vegetables and cheese.", stock: 45, lowStockThreshold: 10, image: "/veggie-pizza-new.png" },
  { id: 503, name: "Delicious Choice Pizza", price: 549, cost: 220, category: "food", description: "Customizable pizza with fresh toppings.", stock: 40, lowStockThreshold: 10, image: "/delicious-pizza.png" },
  { id: 504, name: "French Fries", price: 149, cost: 50, category: "food", description: "Golden fried salted potato strips.", stock: 200, lowStockThreshold: 40, image: "/french-fries.png" },
  { id: 505, name: "Cheese Balls", price: 249, cost: 90, category: "food", description: "Deep-fried cheese stuffed snacks.", stock: 120, lowStockThreshold: 25, image: "/cheese-balls.png" },
  { id: 506, name: "Chicken Pakora", price: 299, cost: 120, category: "food", description: "Spiced chicken fritters.", stock: 100, lowStockThreshold: 20, image: "/chicken-pakora.png" },
  { id: 507, name: "Crispy French Fries (XL)", price: 199, cost: 60, category: "food", description: "Extra large portion of crispy fries.", stock: 100, lowStockThreshold: 20, image: "/crispy-french-fries.png" },

  // Soft Drinks (Category: "drinks")
  { id: 601, name: "Refreshing Cola", price: 99, cost: 30, category: "drinks", description: "Classic chilled cola drink.", stock: 200, lowStockThreshold: 50, image: "/refreshing-cola.png" },
  { id: 602, name: "Bottled Water", price: 49, cost: 15, category: "drinks", description: "Pure mineral water.", stock: 300, lowStockThreshold: 50, image: "/bottled-water.png" },
  { id: 603, name: "Orange Juice", price: 159, cost: 50, category: "drinks", description: "Freshly squeezed 100% natural orange juice.", stock: 100, lowStockThreshold: 20, image: "/glass-of-orange-juice.png" },
  { id: 604, name: "Iced Tea Lemon", price: 149, cost: 40, category: "drinks", description: "Chilled tea with a hint of lemon.", stock: 150, lowStockThreshold: 30, image: "/iced-tea.png" },
  { id: 605, name: "Virgin Mojito", price: 199, cost: 50, category: "drinks", description: "Classic mint and lime mocktail.", stock: 100, lowStockThreshold: 20, image: "/virgin-mojito.png" },

  // Main Courses (Category: "main courses")
...
async function seedDatabase() {
  ...
  try {
    ...
    // Clear all existing products to ensure clean category mapping
